    ...
    <aside class="w-56 bg-[#1e293b] border-r border-gray-700 flex flex-col">
      ...
      <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <router-link 
          to="/task-monitoring" 
          class="flex items-center space-x-3 px-4 py-3 rounded-lg transition"
          :class="route.path === '/task-monitoring' ? 'bg-blue-600 text-white shadow-lg shadow-blue-900/50' : 'text-gray-400 hover:bg-gray-800 hover:text-white'"
        >
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <div v-if="showSystemLogs" class="mt-1 space-y-1 ml-6">
            ...
            <router-link 
              to="/cursor-usage" 
              class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition"
              :class="route.path === '/cursor-usage' ? 'bg-blue-600 text-white shadow-lg shadow-blue-900/50' : 'text-gray-400 hover:bg-gray-800 hover:text-white'"
            >
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
              </svg>
...
const systemLogsPaths = ['/model-usage-stats', '/operation-logs', '/task-run-logs', '/cursor-usage']
