...
class Toolkit:
    ...
    def get_china_stock_data(
        ...
        try:
            ...
            return f"中国股票数据获取失败: {str(e)}。请检查数据源配置和网络连接。"
    ...
    def get_china_market_overview(
        ...
        try:
            ...
            if not adapter.provider or not adapter.provider.connected:
                # 如果Tushare不可用，返回基础信息
                logger.warning(f"⚠️ Tushare不可用，返回基础市场概览")
...
"""
            ...
            return f"中国市场概览获取失败: {str(e)}。请检查数据源配置。"
