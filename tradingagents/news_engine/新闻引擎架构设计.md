...
**AkShare 细分配置**:
- `akshare_cls_enabled`: 财联社
- `akshare_sina_enabled`: 新浪财经
- `akshare_em_enabled`: 东方财富
...
- **优先级**: A股首选
- **子提供者**:
  - `CLSNewsProvider`: 财联社电报 (实时性高)
  - `AkShareSinaNewsProvider`: 新浪财经 (覆盖广)
  - `AkShareEmNewsProvider`: 东方财富 (内容详)
