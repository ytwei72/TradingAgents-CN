...
from app.routers import operation_logs, stock_data, backtest, cache, favorite_stocks, cursor_usage
...
app.include_router(favorite_stocks.router, prefix="/api/favorite-stocks", tags=["favorite_stocks"])
app.include_router(cursor_usage.router, prefix="/api/cursor-usage", tags=["cursor_usage"])
