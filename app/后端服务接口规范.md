...
2. [健康检查接口](#2-健康检查接口)
3. [股票分析接口](#3-股票分析接口)
4. [报告管理接口](#4-报告管理接口-计划中)
5. [用户认证接口](#5-用户认证接口-计划中)
6. [错误码说明](#6-错误码说明)
...
```json
{
  "report_id": "r1b2c3d4-e5f6-7890-abcd-ef1234567890",
  "format": "pdf",
  "status": "generating",
...
Content-Disposition: attachment; filename="AAPL_analysis_2025-12-02.pdf"
```
