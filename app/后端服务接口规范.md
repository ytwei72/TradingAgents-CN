...
4. [报告管理接口](#4-报告管理接口)
5. [通知系统接口](#5-通知系统接口)
6. [WebSocket接口](#6-websocket接口)
7. [用户认证接口](#7-用户认证接口-计划中)
8. [错误码说明](#8-错误码说明)
...
```json
{
  ...
  "updated_at": "2025-12-03T14:35:00",
  "params": {
    "stock_symbol": "AAPL",
    "market_type": "美股",
    "analysts": ["market_analyst", "fundamental_analyst"]
...
```bash
curl http://localhost:8000/api/analysis/a1b2c3d4-e5f6-7890-abcd-ef1234567890/state
```
...
[
  ...
  },
  {
    "task_id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
    "status": "running",
    "updated_at": "2025-12-03T14:32:00",
    "progress": {
      "current_step": 2,
      "percentage": 20.0
    }
